...
<body>
	<header>
		...
		<nav>
			<a href="#services">Serviços</a> <a href="#team">Equipe</a> <a
	...
	<div class="container">
		<section id="services" class="services">
			...
			<div class="service-item">
				...
				<p>Oferecemos consultoria especializada para ajudar sua empresa
					a crescer de forma sustentável.</p>
			</div>
			<div class="service-item">
				<h3>Gestão Financeira</h3>
				<p>Nossos especialistas em finanças irão otimizar a gestão dos
					recursos financeiros da sua empresa.</p>
			</div>
			<div class="service-item">
				<h3>Assessoria Jurídica</h3>
				<p>Prestamos assessoria jurídica completa para garantir a
					segurança legal do seu negócio.</p>
			</div>
		</section>
		...
		<section id="team" class="team">
			...
			<div class="team-member">
				<h3>João Silva</h3>
				<p>CEO e Fundador</p>
				<p>Com mais de 20 anos de experiência em consultoria
					empresarial.</p>
			</div>
			<div class="team-member">
				<h3>Maria Souza</h3>
